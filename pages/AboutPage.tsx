        ...
        <div className="glassmorphism p-6 rounded-lg max-w-4xl mx-auto text-gray-200">
            <div className="flex flex-col items-center text-center mb-12 space-y-4">
                ...
                <div className="space-y-2">
                    <h1 className="text-3xl sm:text-4xl font-bold text-white">Kasir Amanah</h1>
                    <p className="text-base sm:text-lg text-gray-400">Amanah, Cerdas, dan Mandiri</p>
                </div>
            </div>

            <div className="mb-12">
                <h2 className="text-2xl font-semibold text-center mb-6 text-white">Prinsip Amanah</h2>
                <div className="grid md:grid-cols-3 gap-8 text-center">
                    <div className="p-4">
                        <DatabaseZapIcon className="w-12 h-12 mx-auto text-blue-400 mb-3" />
                        <h3 className="text-xl font-bold mb-2">Data Aman & Offline</h3>
                        <p className="text-gray-400 text-sm">Berbasis Web & Offline-First. Data Anda disimpan aman di perangkat, memungkinkan aplikasi berfungsi penuh tanpa koneksi internet setelah dimuat.</p>
                    </div>
                    <div className="p-4">
                        <TrendingUpIcon className="w-12 h-12 mx-auto text-green-400 mb-3" />
                        <h3 className="text-xl font-bold mb-2">Transparansi</h3>
                        <p className="text-gray-400 text-sm">Setiap transaksi dicatat dengan jelas, menautkan kasir yang bertugas untuk akuntabilitas penuh.</p>
                    </div>
                    <div className="p-4">
                        <SettingsIcon className="w-12 h-12 mx-auto text-yellow-400 mb-3" />
                        <h3 className="text-xl font-bold mb-2">Kontrol Penuh</h3>
                        <p className="text-gray-400 text-sm">Fitur backup dan restore yang mudah memberi Anda kendali penuh atas data bisnis Anda.</p>
                    </div>
                </div>
            </div>
            
            <div className="mb-12">
                <h2 className="text-2xl font-semibold text-center mb-6 text-white">Teknologi</h2>
